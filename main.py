...
import requests, subprocess, webbrowser, json, socket, os, time


phot = ''
phot = str('https://vk.com/neko_lovely?z=photo-163966614_457257383%2Fwall-163966614_31629')
url = ''
...
if 2 == data['response'][0]['is_closed']:
  guild_type = 'частное'
else:
